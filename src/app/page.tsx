  ...
  return (
    <main>
      ...
      <Image 
        width={1200} 
        height={1200} 
        role='presentation for visual purposes' 
      ...
      <div className='max-w-7xl mt-20 mx-auto'>
        <div className='flex flex-col items-center relative z-10'>
          {/* Hero Section with Animated Text and Logos */}
          <h1 className={`text-6xl max-w-3xl text-center leading-snug mb-12 ${poppins.className}`}>
            <Image 
              alt='Figma Logo'
